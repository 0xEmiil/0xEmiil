[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&random=false&width=435&lines=Software+Engineering+Student%2C+0xEmil)](https://git.io/typing-svg)
```
#include <stdio.h>
#include <string.h>
